...
const decoration = { version: 1, enabled: true, outline: { enabled: true, title: '【この記事でわかること】' }, section_navigation: { enabled: true, minimum_h3: 3, default_title: 'この章でわかること' }, intro_summary: { enabled: true, title: 'この記事でわかること' }, list_boxes: [], markers: [] };
